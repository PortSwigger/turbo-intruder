...
/**
 * The canonical Huffman code of RFC 7541 Appendix B. QPACK uses it unmodified — RFC 9204
 * section 4.1.2: "the Huffman table from Appendix B of [RFC7541] is used without modification".
 *
 * <p>257 symbols: byte values 0-255 plus EOS at index 256. Codes are right-aligned in
 * {@link #CODES} and their true bit lengths are in {@link #LENGTHS}.
 *
 * <p>Generated from the RFC text. Verified at generation time to be internally consistent and a
...
final class HuffmanTable {
    ...
    /** Index of the end-of-string symbol. Encoding it is a decode error, per RFC 7541 section 5.2. */
