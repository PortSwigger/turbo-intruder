...
//    }
    ...
    void queue(String req, int pauseBefore, int pauseTime) {
        engine.queue(req, new ArrayList<>(), 0, null, null, "", pauseBefore, pauseTime, new ArrayList<>(), 0, null, null, true, null, false); // , Integer.toString(id++)
    }
    ...
    ArrayList<Resp> blockingRequest(ArrayList<byte[]> reqs, int pauseBefore, List<String> pauseMarkers, int pauseTime) {
        ...
        for (byte[] req: reqs) {
            ...
            }, gateName, "", pauseBefore, pauseTime, pauseMarkers, 0, null, null, true, null, false);
            index += 1;
        }
